    ...
    if (typeof booksData !== 'undefined') {
        ...
        sortedBooks.forEach(book => {
            ...
            card.innerHTML = `
                ...
                <div class="card-content">
                    <h4>${book.name}${(book.id === 'codex-chaoticus-pdf' || book.id === 'tarot-chaos-pdf') ? ' <span class="discount-badge">¡NUEVO!</span>' : ''}</h4>
    ...
    detailsContainer.innerHTML = `
        <div class="detail-header-layout">
            ...
            <div class="detail-header-info">
                <h2>${item.name}${(item.id === 'psi-gym' || item.id === 'dream-machine' || item.id === 'codex-chaoticus-pdf' || item.id === 'tarot-chaos-pdf') ? ' <span class="discount-badge">¡NUEVO!</span>' : ''}</h2>
